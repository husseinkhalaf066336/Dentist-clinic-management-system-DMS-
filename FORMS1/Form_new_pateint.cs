...
namespace dentis
{
    public partial class Form_new_pateint : Form
    {
        ...
        picteres_pat picteres_pat = new picteres_pat();
        ...
        public Form_new_pateint()
        {
            ...
            if (s == "add")
            {
                ...
                picteres_pat.id_pic = Convert.ToInt32(textBox1.Text);
            }
            else
            {
                textBox1.Text = id_patient.ToString();
                picteres_pat.id_pic = id_patient;
            }
        ...
        private void bunifuTileButton3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Class_patient.edit_patient(textBox2.Text, textBox3.Text, d, g, textBox4.Text, baytimag, id_patient);
