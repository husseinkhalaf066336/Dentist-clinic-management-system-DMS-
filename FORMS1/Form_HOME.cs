    ...
    public partial class Form_HOME : Form
    {
     ...
     //       btn_mng_empl.Visible = false;
        ...
        private void bunifuTileButton2_Click_1(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("ليس لديك الصلاحية بلدخول إلى اعدادات السيرفير ،هذه النافذة خاصة فقط بلمسؤلين ", "الصلاحيات ", MessageBoxButtons.OK, MessageBoxIcon.Stop);
